...
if archivo_csv is not None:
    ...
    if st.button("🔍 Predecir desde CSV"):
        ...
        if len(predicciones) == len(datos_csv):
            ...
            st.error(f"La API devolvió {len(predicciones)} predicciones para {len(datos_csv)} filas. Revisa los datos o la respuesta.")
            st.write("Respuesta completa de la API:", resultado)
